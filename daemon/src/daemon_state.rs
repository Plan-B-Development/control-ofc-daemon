...
//! Default state_dir is `/var/lib/control_ofc` (configurable via `[state]` in
...
const DEFAULT_STATE_DIR: &str = "/var/lib/control_ofc";
...
mod tests {
    ...
    fn roundtrip_serialize() {
        let state = DaemonState {
            ...
            active_profile_path: Some("/etc/control_ofc/profiles/quiet.json".into()),
        };
